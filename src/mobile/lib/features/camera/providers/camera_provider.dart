...
class CameraNotifier extends StateNotifier<CameraState> {
  ...
  Future<String?> _saveDrawingRecord({
    ...
    try {
      ...
      _debug.success('Database', 'Drawing record created: $drawingId');
      return drawingId;
    } catch (e) {
      // CHANGED: Throw error instead of returning null so user sees the issue
      _debug.error('Database', 'Failed to save drawing record', error: e);
